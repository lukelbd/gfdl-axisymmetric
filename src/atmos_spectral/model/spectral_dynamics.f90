...
subroutine spectral_dynamics(Time, psg_final, ug_final, vg_final, tg_final, tracer_attributes, grid_tracers_final, &
                             ...
                             dt_ug_damp, dt_vg_damp, dt_tg_damp, dt_ug_diff)
...
id_u_diff =  register_diag_field(mod_name, 'udt_diff',  axes_3d_full, Time, 'Zonal wind tend from vert diff',      'm/s**2')
...
!===================================================================================
subroutine spectral_diagnostics(Time, p_surf, u_grid, v_grid, t_grid, wg_full, tr_grid, dt_ug_damp, dt_vg_damp, dt_tg_damp, dt_ug_diff)
...
do k = 1,num_levels
  ...
  enddo
enddo
if(id_u_diff > 0) used = send_data(id_u_diff, dt_ug_diff, Time)
